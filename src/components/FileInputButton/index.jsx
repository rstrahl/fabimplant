...
export default class FileInputButton extends React.Component {
	...
	render() {
		...
		return (
			<label className={styles.fileInputButton} htmlFor={formId}>
				<figure className={styles.fileInputIcon}>
				...
				<span className={styles.text}><strong>Choose DICOM files</strong> or drag them here</span>
			</label>
		);
	}
